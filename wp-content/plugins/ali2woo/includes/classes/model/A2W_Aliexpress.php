...
if (!class_exists('A2W_Aliexpress')) {
    ...
    class A2W_Aliexpress {
        ...
        public function load_product($product_id, $params = array()) {
            ...
            $request_url = A2W_RequestHelper::build_request('get_product', array('product_id' => $product_id, 'skip_desc'=>a2w_get_setting('not_import_description')));
            ...
            if (is_wp_error($request)) {
                ...
                if ($result['state'] !== 'error') {
                    ...
                    if (!a2w_get_setting('not_import_description') && isset($result['product']['desc_meta']['desc_url'])) {
                        $response = a2w_remote_get($result['product']['desc_meta']['desc_url']);
