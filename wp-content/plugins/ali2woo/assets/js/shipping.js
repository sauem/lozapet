jQuery(document).ready(function($){
   ...
   a2w_shipping_api.init_in_cart = function(t){
        ...
        $('#a2w_to_country_field').on('change', function() {
            ...
            $('<input type="hidden" name="a2w_skip_postcode_validate" value="1"/>').appendTo('.woocommerce-shipping-calculator');
       ...
       $('#a2w_to_country_field').trigger('change');
   }
   ...
   $( "body" ).trigger( 'a2w_shipping_js_loaded',[a2w_shipping_api]);
