...
(function ($, window, document, undefined) {
    $(function () {
        ...
        $(".product-card-split-product").on("click", function () {
            ...
            $(".modal-split-product").fadeIn(400);
            ...
            jQuery.post(ajaxurl, { 'action': 'a2w_get_product', 'id': product.id }).done(function (response) {
                ...
                if (json.state !== 'ok') {
                    ...
                    $.each(json.product.sku_products.attributes, function (i, attr) {
        ...
        $('#modal-country-select').on('change', function (evt) {
            ...
            if ($(this).val() && $(this).val() != "" && tmp_data.country != $(this).val()) {
                ...
                a2w_load_shipping_info(tmp_data.product_id, tmp_data.country, tmp_data.page, function (state, items) {
                    if (state != 'error') {
                        tmp_data.shipping = items;
