...
<div class="woocommerce-billing-fields checkbox-form">
    ...
    <div class="woocommerce-billing-fields__field-wrapper">
        <div class="row checkout-form-list">
            ...
            $col6 = ['billing_first_name', 'billing_last_name', 'billing_state', 'billing_postcode', 'billing_email', 'billing_phone'];

            foreach ($fields as $key => $field) {
                $field['class'] = [in_array($key, $col6) ? 'col-md-6' : 'col-12'];
                ?>
                <?php
